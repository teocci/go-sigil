...
import (
	...
	jsparser "go-sigil/internal/parser/javascript"
)
...
func TestJSParser_Parse_Symbols(t *testing.T) {
	p := jsparser.New()
	src := loadFixture(t, "sample.js")

	result, err := p.Parse("src/sample.js", "src", src)
	if err != nil {
...
func TestJSParser_Parse_SymbolIDs(t *testing.T) {
	p := jsparser.New()
	src := loadFixture(t, "sample.js")
...
func TestJSParser_Parse_QualifiedNames(t *testing.T) {
	p := jsparser.New()
	src := loadFixture(t, "sample.js")

	result, err := p.Parse("src/sample.js", "mypkg", src)
	if err != nil {
		t.Fatalf("Parse: %v", err)
	}
...
func TestJSParser_Parse_Summaries(t *testing.T) {
	p := jsparser.New()
	src := loadFixture(t, "sample.js")
...
func TestJSParser_Parse_Edges(t *testing.T) {
	p := jsparser.New()
	src := loadFixture(t, "sample.js")
...
func TestJSParser_Parse_EmptyFile(t *testing.T) {
	p := jsparser.New()
	result, err := p.Parse("empty.js", "pkg", []byte(""))
	if err != nil {
